...
/*
gedit c2.c
tlog@ubuntuM1:~/Desktop/External/sliding/go$ gcc c2.c -o c
tlog@ubuntuM1:~/Desktop/External/sliding/go$ ./c
...
Client: ACK received for packet 5
Client: Timeout! Retransmitting from packet 2...
Client: Sending packet 2
Client: Sending packet 3
Client: Sending packet 4
Client: Sending packet 5
Client: ACK received for packet 4
Client: Timeout! Retransmitting from packet 2...
Client: Sending packet 2
Client: Sending packet 3
Client: Sending packet 4
...
Client: Timeout! Retransmitting from packet 3...
Client: Sending packet 3
Client: Sending packet 4
Client: Sending packet 5
Client: Sending packet 6
Client: ACK received for packet 3
Client: Sending packet 7
Client: Timeout! Retransmitting from packet 4...
Client: Sending packet 4
Client: Sending packet 5
Client: Sending packet 6
Client: Sending packet 7
...
Client: Timeout! Retransmitting from packet 5...
Client: Sending packet 5
Client: Sending packet 6
Client: Sending packet 7
Client: Sending packet 8
...
Client: Timeout! Retransmitting from packet 6...
Client: Sending packet 6
Client: Sending packet 7
Client: Sending packet 8
Client: Sending packet 9
...
Client: Timeout! Retransmitting from packet 7...
Client: Sending packet 7
Client: Sending packet 8
Client: Sending packet 9
Client: Sending packet 10
...
Client: Sending packet 10
Client: ACK received for packet 8
Client: Timeout! Retransmitting from packet 9...
Client: Sending packet 9
Client: Sending packet 10
Client: ACK received for packet 9
